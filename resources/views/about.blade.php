<x-app-layout>
    <section class="page_breadcrumb" style="background: url('{{ asset('images/about_main.jpg') }}');">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="about_us_img">
                        <div class="img">
                            <img src="{{ asset('images/chefs_about.jpg') }}" alt="about us" class="img-fluid w-100">
                        </div>
    ...
    <section class="mission mt_100 xs_mt_70" style="background: url('{{ asset('images/about_goal.jpg') }}');">
            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="about_choose_img">
                        <img src="{{ asset('images/delivery.jpg') }}" alt="about us" class="img-fluid w-100">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="counter_part mt_100 xs_mt_70" style="background: url('{{ asset('images/about_vision.jpg') }}');">
                    ...
                    @if ($latestTestimonial)
                        <div class="single_testimonial">
                            <div class="single_testimonial_img">
                                <img src="{{ asset('uploads/testimonial/' . $latestTestimonial->image) }}"
                                    alt="testimonial" class="img-fluid w-100">
                            </div>
                            <div class="single_testimonial_text">
                                <h4>{{ $latestTestimonial->name }}</h4>
                                <p class="designation">Client</p>
                                <p class="feedback">{{ $latestTestimonial->message }}</p>
                                <span class="rating">
