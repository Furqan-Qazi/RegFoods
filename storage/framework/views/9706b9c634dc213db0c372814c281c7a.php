...
<?php $component->withAttributes([]); ?>
            ...
            <section class="banner">
                <div class="banner_overlay">
                    <span class="banner_shape_1">
                        <img src="<?php echo e(asset('images/tree_5.png')); ?>" alt="shape" class="img-fluid w-100">
                    </span>
                    <span class="banner_shape_2">
                        <img src="<?php echo e(asset('images/tree_3.png')); ?>" alt="shape" class="img-fluid w-100">
                    </span>
                    <span class="banner_shape_3">
                        <img src="<?php echo e(asset('images/tree_4.png')); ?>" alt="shape" class="img-fluid w-100">
                    </span>
                    <span class="banner_shape_4">
                        <img src="<?php echo e(asset('images/tree_6.png')); ?>" alt="shape" class="img-fluid w-100">
                    </span>
                    <span class="banner_shape_5">
                        <img src="<?php echo e(asset('images/tree_7.png')); ?>" alt="shape" class="img-fluid w-100">
                    </span>
                    <span class="banner_shape_6">
                        <img src="<?php echo e(asset('images/tree_2.png')); ?>" alt="shape" class="img-fluid w-100">
                    </span>
                    <div class="col-12">
                        <div class="banner_slider" style="background: url('<?php echo e(asset('images/slider3.jpg')); ?>');">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-xxl-5 col-xl-6 col-sm-10 col-md-9 col-lg-6">
                                            <div class="banner_img wow fadeInRight" data-wow-duration="1s">
                                                <div class="img">
                                                    <img src="<?php echo e(asset('images/slider2.jpg')); ?>" alt="food item"
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xl-4">
                                <div class="offer_item_single"
                                    style="background: url('<?php echo e(asset('uploads/items/' . $item->image)); ?>');">
                                    <span><?php echo e($item->discount); ?>% off</span>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="cart_popup_img">
                                    <img src="<?php echo e(asset('images/popup_cart_img.jpg')); ?>" alt="menu"
                                        class="img-fluid w-100">
                                </div>
    ...
    ==============================-->
            <section class="reservation mt_100 xs_mt_70">
                <div class="container">
                    <div class="reservation_bg" style="background: url('<?php echo e(asset('images/about_main.jpg')); ?>');">
                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="reservation_input_single">
                                                    ...
                                                    <input type="date" id="reservation_date"
                                                        name="reservation_date" value="<?php echo e(old('reservation_date')); ?>"
                                                        required>
                                                </div>
                                            </div>
                                                ...
                                                <div class="reservation_input_single">
                                                    ...
                                                    <select id="reservation_time" name="reservation_time"
                                                        ...
                                                        <option value="08.00 am to 09.00 am"
                                                            <?php echo e(old('reservation_time') == '08.00 am to 09.00 am' ? 'selected' : ''); ?>>
                                                            08.00 am to 09.00 am</option>
                                                        <option value="10.00 am to 11.00 am"
                                                            <?php echo e(old('reservation_time') == '10.00 am to 11.00 am' ? 'selected' : ''); ?>>
                                                            10.00 am to 11.00 am</option>
                                                        <option value="12.00 pm to 01.00 pm"
                                                            <?php echo e(old('reservation_time') == '12.00 pm to 01.00 pm' ? 'selected' : ''); ?>>
                                                            12.00 pm to 01.00 pm</option>
                                                        <option value="02.00 pm to 03.00 pm"
                                                            <?php echo e(old('reservation_time') == '02.00 pm to 03.00 pm' ? 'selected' : ''); ?>>
                                                            02.00 pm to 03.00 pm</option>
                                                        <option value="04.00 pm to 05.00 pm"
                                                            <?php echo e(old('reservation_time') == '04.00 pm to 05.00 pm' ? 'selected' : ''); ?>>
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="reservation_input_single">
                                                    ...
                                                    <select id="number_of_people" name="number_of_people"
                                                        ...
                                                        <option value="">Select</option>
                                                        <option value="1"
                                                            <?php echo e(old('number_of_people') == '1' ? 'selected' : ''); ?>>1
                                                            person</option>
                                                        <option value="2"
                                                            <?php echo e(old('number_of_people') == '2' ? 'selected' : ''); ?>>2
                                                            person</option>
                                                        <option value="3"
                                                            <?php echo e(old('number_of_people') == '3' ? 'selected' : ''); ?>>3
                                                            person</option>
                                                        <option value="4"
                                                            <?php echo e(old('number_of_people') == '4' ? 'selected' : ''); ?>>4
                                                            person</option>
                                                        <option value="5"
                                                            <?php echo e(old('number_of_people') == '5' ? 'selected' : ''); ?>>5
                                                            person</option>
                                                    </select>
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-duration="1s">
                            <div class="menu_filter d-flex flex-wrap">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button
                                        data-filter=".cat<?php echo e($category->category_id); ?>"><?php echo e($category->name); ?></button>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row grid">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $category->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-xxl-3 col-sm-6 col-lg-4 cat<?php echo e($category->category_id); ?> wow fadeInUp"
                    ...
                    <div class="row wow fadeInUp" data-wow-duration="1s">
                        <div class="col-xl-6 col-lg-6">
                            <div class="add_slider_single"
                                style="background: url('<?php echo e(asset('images/blog_main.jpg')); ?>');">
                                <div class="text">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="add_slider_single"
                                style="background: url('<?php echo e(asset('images/biryani.jpg')); ?>');">
                                <div class="text">
                                    <h5>daily offer</h5>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="download_text_bg"
                                style="background: url('<?php echo e(asset('images/about_goal.jpg')); ?>');">
                            ...
                            <div class="row download_slider_item">
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="download_slider">
                                        <img src="<?php echo e(asset('images/slider4.jpg')); ?>" alt="app download"
                                            class="img-fluid w-100">
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="download_slider">
                                        <img src="<?php echo e(asset('images/delivery.jpg')); ?>" alt="app download"
                                            class="img-fluid w-100">
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="download_slider">
                                        <img src="<?php echo e(asset('images/slider2.jpg')); ?>" alt="app download"
                                            class="img-fluid w-100">
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="download_slider">
                                        <img src="<?php echo e(asset('images/menu_main.jpg')); ?>" alt="app download"
                                            class="img-fluid w-100">
    ...
    ==============================-->
            <section class="testimonial pt_90 xs_pt_60 pb_100 xs_pb_70"
                style="background: url('<?php echo e(asset('images/testimonial_bg.jpg')); ?>');">
                <div class="container">
                    <div class="row wow fadeInUp" data-wow-duration="1s">
                        <div class="col-md-8 col-lg-7 col-xl-6">
                            ...
                            <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s">
                                <div class="single_testimonial">
                                    <div class="single_testimonial_img">
                                        <img src="<?php echo e(asset('uploads/testimonial/' . $testimonial->image)); ?>"
                                            alt="testimonial" class="img-fluid w-100">
                                    </div>
                                    <div class="single_testimonial_text">
                                        <h4><?php echo e($testimonial->name); ?></h4>
                                        <p class="designation"><?php echo e($testimonial->location); ?></p>
    ...
    ==============================-->
        ...
        COUNTER START
    ==============================-->
            <section class="counter_part" style="background: url('<?php echo e(asset('images/reservation_bg.jpg')); ?>');">
                            ...
                            <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1s">
                                <div class="single_blog">
                                    ...
                                    <div class="single_blog_author">
                                        <div class="img">
                                            <img src="<?php echo e(asset('images/default_author.jpg')); ?>" alt="author"
                                                class="img-fluid w-100">
                                        </div>
                                        <div class="text">
                                    ...
                                    <div class="single_blog_text">
                                        ...
                                        <a class="title"
                                            href="<?php echo e(route('blog_page', $blog->slug)); ?>"><?php echo e($blog->title); ?></a>
...
<?php /**PATH C:\xampp\htdocs\laravel\resturant\resources\views/welcome.blade.php ENDPATH**/ ?>